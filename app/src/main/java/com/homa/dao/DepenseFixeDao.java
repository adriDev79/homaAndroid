...
public interface DepenseFixeDao {
     ...
     * @return {@code DepenseFixe}
     */
    @Query("UPDATE depensefixe SET libelle = :libelle, montant = :montant, date_de_modification = :dateModif, date_de_prelevement = :datePrel, id_type_depense = :idTypeDepense WHERE id = :id")
